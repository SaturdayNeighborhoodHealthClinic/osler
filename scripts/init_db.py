...
for drug_category in ["Other", "Supplements", "Allergy", "Cardiovascular",
                      "Pain Relief", "Antibiotics", "Endocrine/GI", "Respiratory"]:
  category = inventory.DrugCategory(name=drug_category)
  category.save()

for units in ["mg", "%", "IU", "mL", "mEq", "mcg"]:
  unit = inventory.MeasuringUnit(name=units)
  unit.save()
